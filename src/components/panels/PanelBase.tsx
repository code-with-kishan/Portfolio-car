      ...
      {isVisible && (
        <motion.div
          ...
          style={{
            ...
            maxHeight: '80vh',
            overflowY: 'auto',
            background: 'linear-gradient(135deg, rgba(0,5,15,0.96) 0%, rgba(0,15,30,0.96) 100%)',
            backdropFilter: 'blur(18px)',
            WebkitBackdropFilter: 'blur(18px)',
            border: `1px solid ${color}88`,
            borderRadius: 16,
            boxShadow: `0 0 60px ${color}44, 0 0 120px ${color}22, inset 0 0 60px rgba(0,0,0,0.4), 0 8px 32px rgba(0,0,0,0.6)`,
            zIndex: 100,
            padding: '28px 32px',
